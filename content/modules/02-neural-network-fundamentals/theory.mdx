...
lastConverted: "2026-04-10T18:28:36.954Z"
---
## Module Overview
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-tip" data-callout-type="tip" data-callout-label="Key Insight">
  ...
  <div class="text-text-secondary leading-relaxed">The convergence rate depends inversely on the square of the margin. Better-separated data converges faster.</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-note" data-callout-type="note" data-callout-label="Example">
  ...
  <div class="text-text-secondary leading-relaxed">Color encoding - Red → [1, 0, 0] - Green → [0, 1, 0]   - Blue → [0, 0, 1]</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-tip" data-callout-type="tip" data-callout-label="Key Insight">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Key Insight</div>
  <div class="text-text-secondary leading-relaxed">The theorem guarantees existence of a solution but says nothing about: - How to find the weights (optimization) - How many neurons are needed (capacity) - Whether the solution generalizes (statistical learning theory)</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-tip" data-callout-type="tip" data-callout-label="Key Insight">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Key Insight</div>
  <div class="text-text-secondary leading-relaxed">The gradient is simply the prediction error, making optimization efficient.</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-warning" data-callout-type="warning" data-callout-label="Important">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Important</div>
  <div class="text-text-secondary leading-relaxed">While individual loss functions may be convex, the composition with a neural network is generally non-convex due to: - Non-linear activations - Multiple layers - Weight interactions</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-note" data-callout-type="note" data-callout-label="Example">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Example</div>
  <div class="text-text-secondary leading-relaxed">Compute $f(x, y, z) = (x + y) \cdot z$</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-note" data-callout-type="note" data-callout-label="Example">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Example</div>
  <div class="text-text-secondary leading-relaxed">For faces, separate: - Identity - Pose - Expression - Lighting</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-note" data-callout-type="note" data-callout-label="Example">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Example</div>
  <div class="text-text-secondary leading-relaxed"></div>
</div>
```python
