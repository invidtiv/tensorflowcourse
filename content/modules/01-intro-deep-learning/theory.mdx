...
lastConverted: "2026-04-10T18:28:36.921Z"
---
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-tip" data-callout-type="tip" data-callout-label="Key Insight">
  ...
  <div class="text-text-secondary leading-relaxed">Multi-layer networks with non-linear activation functions can approximate any continuous function (Universal Approximation Theorem), and backpropagation provides an efficient way to train them.</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-tip" data-callout-type="tip" data-callout-label="Key Insight">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Key Insight</div>
  <div class="text-text-secondary leading-relaxed">In high dimensions, most critical points are saddle points, not local minima.</div>
</div>
...
<div class="my-6 rounded-xl border border-white/[0.08] bg-surface-1/30 px-4 py-3 callout callout-tip" data-callout-type="tip" data-callout-label="Key insight">
  <div class="text-[11px] font-mono font-semibold uppercase tracking-wider text-neon-cyan mb-1">Key insight</div>
  <div class="text-text-secondary leading-relaxed">Backward pass is approximately the same cost as forward pass!</div>
</div>
